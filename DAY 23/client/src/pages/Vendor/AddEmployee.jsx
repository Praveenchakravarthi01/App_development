                                    ...
                                    <div className="mt-2">
                                        <Select name="service" label="Select Service" value={serviceName}>
                                            {services?.map((service,i) => {
                                                return (
                                                    <Option key={i}  onClick={() => {setSid(service.sid);setServiceName(service?.serviceName);setEmployee({...service,"serviceName":service?.serviceName})}}>{service.serviceName}</Option>
                                                )
                                            })}
                                        </Select>
                                    </div>
